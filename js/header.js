        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./inicio.html">Creador de Articulos (ADMINISTRADOR)</a>
                    </li>
                </ul>
            </div>
        </div>
    </nav>
    <ul id="collapseExample" class="chicos collapse" aria-expanded="false" >
    </ul>`);

$("#fotoPrincipalIndexInv").append(`<div class="fotoInicial">
    <h2 class="animate__animated animate__rubberBand intro">¡Bienvenido a Milema Home & Deco!</h2>
</div>`);
...
<nav class="navbar navbar-light" style="background-color: #b99d9a;">
    <div class="container-fluid">
        <a class="navbar-brand" href="PPAdmin.html"><h1>Milema</h1></a>
    </div>
</nav>`);

$("#fotoPrincipalIndexAdm").append(`<div class="fotoInicial">
<div class="intro">
    <h2 class="animate__animated animate__rubberBand">Bienvenido Administrador!</h2>
</div>
</div>`);
